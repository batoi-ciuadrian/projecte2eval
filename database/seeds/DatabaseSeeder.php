...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayPeliculas = array(
		...
		array(
			...
			'poster' => 'https://m.media-amazon.com/images/M/MV5BZWNmODRmOTAtYTJhYi00NjllLTg3MTktNTBmZDZiNjJjZWVjXkEyXkFqcGdeQXVyNTc1NTQxODI@._V1_UX182_CR0,0,182,268_AL_.jpg', 
			'rented' => false, 
    ...
    private function seedUsers() {
        ...
        $user1 = new User;
        $user1->name = 'Anguel';
        $user1->email = 'angueltoloko@gmail.com';
        $user1->password = bcrypt('1234');
        $user1->save();
        $user2 = new User;
        $user2->name = 'Adrian';
        $user2->email = 'adriantoloko@gmail.com';
